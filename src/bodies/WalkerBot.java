...
public class WalkerBot extends Walker{
    ...
    private static final BodyImage image =
            new BodyImage("data/WalkerLeft.png", 5f);

    public WalkerBot(World world) { //Constructor which sets the gravity and hp of the walker bot
